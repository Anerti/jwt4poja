...
public class StudentController {
  ...
  public ResponseEntity<UserExtendStudent> enrollStudentInClass(
      @PathVariable UUID studentId, @RequestBody EnrollClassInput request) {
    return ResponseEntity.status(HttpStatus.OK)
        .body(studentService.enrollStudentInClass(studentId, request));
  }
}
