package com.techindna.anerti.endpoint.event.consumer;

import com.techindna.anerti.PojaGenerated;
import com.techindna.anerti.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.techindna.anerti.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.techindna.anerti.service.event."
