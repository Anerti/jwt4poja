...
public class GraduationService {
  ...
  public GraduationListResponse listGraduates(UUID classId) {
    ...
    List<Object[]> rows = graduationRepository.findGraduatesByClassId(classId);
  ...
  @Transactional(readOnly = true)
  public List<GraduateOutput> getGraduates(UUID classId) {
    listGraduates(classId);
    return listGraduates(classId).graduates();
  }
}
