...
class PatchGradesIT extends FacadeIT {
  ...
  @Test
  void correction_appends_history_and_updates_current_grade() {
    ...
    ResponseEntity<GradeOutput> response =
        restTemplate.exchange(
            ...
            HttpMethod.PATCH,
            new HttpEntity<>(
                new UpdateGradeInput(new BigDecimal("15"), "Forgot to add bonus points"),
    ...
    assertThat(body.grade()).isEqualByComparingTo(new BigDecimal("15"));

    assertThat(gradeHistoryRepository.findAll())
        .extracting(JGradeHistory::getGrade)
        .containsExactly(new BigDecimal("14.5"), new BigDecimal("15"));
  }

  @Test
  void missing_description_is_unprocessable() {
    JStudentInheritance student = saveStudent();
    JExam exam = saveExam(saveCourse("EP1"), "0.5", 2023, "2024-01-15T09:00:00Z");
    JGrade grade = saveGrade(student, exam, "14.5", "Final exam");
    ...
    ResponseEntity<String> response =
        restTemplate.exchange(
            ...
            HttpMethod.PATCH,
            new HttpEntity<>(
                new UpdateGradeInput(new BigDecimal("15"), null), jsonHeaders(adminToken())),
            String.class);
  ...
  void blank_description_is_unprocessable() {
    ...
    ResponseEntity<String> response =
        restTemplate.exchange(
            ...
            HttpMethod.PATCH,
            new HttpEntity<>(
                new UpdateGradeInput(new BigDecimal("15"), "   "), jsonHeaders(adminToken())),
            String.class);
  ...
  void grade_above_range_is_unprocessable() {
    ...
    ResponseEntity<String> response =
        restTemplate.exchange(
            ...
            HttpMethod.PATCH,
            new HttpEntity<>(
                new UpdateGradeInput(new BigDecimal("20.5"), "Recheck"), jsonHeaders(adminToken())),
            String.class);
  ...
  void unknown_grade_is_not_found() {
    ...
    ResponseEntity<String> response =
        restTemplate.exchange(
            ...
            HttpMethod.PATCH,
            new HttpEntity<>(
                new UpdateGradeInput(new BigDecimal("15"), "Recheck"), jsonHeaders(adminToken())),
            String.class);
  ...
  @Test
  void teacher_cannot_correct_grade_of_unassigned_course() {
    ...
    ResponseEntity<String> response =
        restTemplate.exchange(
            ...
            HttpMethod.PATCH,
            new HttpEntity<>(
                new UpdateGradeInput(new BigDecimal("15"), "Recheck"),
                jsonHeaders(teacherToken(teacher))),
            String.class);
